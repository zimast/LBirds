...
export class GetRandomBirdService {
  ...
  private birds: Bird[] = [
    ...
    // { name: "bazant kralovsky", latinName: "syrmaticus-reevesii", numberOfImages: null },
    // { name: "bazant zlaty", latinName: "chrysolophus-pictus", numberOfImages: null },
    // { name: "bazant stribrny", latinName: "lophura-nycthemera", numberOfImages: null },
    // { name: "perlicka kropenata", latinName: "numida-meleagris", numberOfImages: null },
    // { name: "holub hrivnac", latinName: "columba-palumbus", numberOfImages: null },
    // { name: "hrdlicka zahradni", latinName: "streptopelia-decaocto", numberOfImages: null },
    // { name: "holoubek diamantovy", latinName: "geopelia-cuneata", numberOfImages: null },
    // { name: "dronte mauricijsky", latinName: "raphus-cucullatus", numberOfImages: null },
    // { name: "dodo", latinName: "raphus-cucullatus", numberOfImages: null },
    // { name: "potapka rohac", latinName: "podiceps-cristatus", numberOfImages: null },
    // { name: "albatros", latinName: "diomedea", numberOfImages: null },
    // { name: "kormoran velky", latinName: "phalacrocorax-carbo", numberOfImages: null },
    // { name: "volavka popelava", latinName: "ardea-cinerea", numberOfImages: null },
